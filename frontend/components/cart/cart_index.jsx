...
class CartIndex extends React.Component {
  ...
  render() {
    if (this.state.loaded) {
      let cartItems = this.props.cartItems.map((cartItem, idx) => <CartIndexItem key={`cartItem-${idx}`} cartItem={cartItem} product={this.props.products[cartItem.product_id]} fetchCart = {this.props.fetchCart} deleteCartItem={this.props.deleteCartItem} updateCartItem={this.props.updateCartItem}/>)
